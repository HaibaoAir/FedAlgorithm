...
class Server(object):
    def __init__(self, args):
        ...
        # 初始化data_matrix[K,T]
        self.data_origin_init = [random.randint(800, 900) for _ in range(self.num_client)]
    ...
    def online_train(self):
        # 正式训练前定好一切
        pre_estimate_path_1 = self.pre_estimate_path_1 + str('_back.npy'.format(self.sigma))
        pre_estimate_path_2 = self.pre_estimate_path_2 + str('_back.npy'.format(self.sigma))
