...
args = {
    ...
    'batch_size': 32,
    'eval_freq': 1,
    'save_path_1': '../../logs/fedstream/3_server_1',
    'save_path_2_delta': '../../logs/fedstream/3_server_2_delta',
    'save_path_2_data': '../../logs/fedstream/3_server_2_data',
    'save_path_2_stale': '../../logs/fedstream/3_server_2_stale',
    'save_path_2_cost': '../../logs/fedstream/3_server_2_cost',
    'save_path_3': '../../logs/fedstream/3_server_3',
    'save_path_4_loss': '../../logs/fedstream/3_server_4_loss',
    'save_path_4_acc': '../../logs/fedstream/3_server_4_acc',
    'pre_estimate_path_1': '../../logs/fedstream/pre_estimate_3_1',
    'pre_estimate_path_2': '../../logs/fedstream/pre_estimate_3_2',
...
class Server(object):
    ...
    def online_train(self):
        ...
        for idx in range(len(enum)):
            ...
            # new_gamma = 5e-3
            # cost_1_list = (1 - new_gamma) * np.array(hist_global_loss_list)
            ...
            # plt.legend(frameon=False)
            # plt.savefig(self.save_path_3 + '_{}.png'.format(self.sigma), dpi=200)
            # plt.close()
            ...
            for n in range(idx+1):
                ...
                plt.legend()
                plt.savefig(self.save_path_4_loss + '_{}.png'.format(self.sigma), dpi=200)
            plt.close()
